...
exports.handler = async (event, context) => {
  try {
    ...
    const rawData = [
      ...
      { id: 26, nome: "Igreja Angelim Parnaíba (Sede)", dia: "Vários", horario: "Diversos", bairro: "Reis Veloso", endereco: "Av. Dep. Pinheiro Machado, 115", lider: "Igreja Local", contato: "-", obs: "Cultos: Qua 19:30 | Sáb 18:00 | Dom 10:00 e 18:00", lat: "-2.904959551930751", lng: "-41.75327635838159" }
    ];
